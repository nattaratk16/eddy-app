...
export const PASTEL_COLORS: PastelColorOption[] = [
  { value: 'pink', label: 'ชมพู', swatchClass: 'bg-pastel-pink-dark', chipClass: 'bg-pastel-pink text-chip-ink', dotClass: 'bg-pastel-pink-dark', strokeClass: 'stroke-pastel-pink-dark' },
  { value: 'yellow', label: 'เหลือง', swatchClass: 'bg-pastel-yellow-dark', chipClass: 'bg-pastel-yellow text-chip-ink', dotClass: 'bg-pastel-yellow-dark', strokeClass: 'stroke-pastel-yellow-dark' },
  { value: 'mint', label: 'มิ้นท์', swatchClass: 'bg-pastel-mint-dark', chipClass: 'bg-pastel-mint text-chip-ink', dotClass: 'bg-pastel-mint-dark', strokeClass: 'stroke-pastel-mint-dark' },
  { value: 'blue', label: 'ฟ้า', swatchClass: 'bg-pastel-blue-dark', chipClass: 'bg-pastel-blue text-chip-ink', dotClass: 'bg-pastel-blue-dark', strokeClass: 'stroke-pastel-blue-dark' },
  { value: 'peach', label: 'พีช', swatchClass: 'bg-pastel-peach-dark', chipClass: 'bg-pastel-peach text-chip-ink', dotClass: 'bg-pastel-peach-dark', strokeClass: 'stroke-pastel-peach-dark' },
  { value: 'lilac', label: 'ม่วงอ่อน', swatchClass: 'bg-pastel-lilac-dark', chipClass: 'bg-pastel-lilac text-chip-ink', dotClass: 'bg-pastel-lilac-dark', strokeClass: 'stroke-pastel-lilac-dark' },
  { value: 'amber', label: 'อำพัน', swatchClass: 'bg-pastel-amber-dark', chipClass: 'bg-pastel-amber text-chip-ink', dotClass: 'bg-pastel-amber-dark', strokeClass: 'stroke-pastel-amber-dark' },
  { value: 'lime', label: 'เขียวมะนาว', swatchClass: 'bg-pastel-lime-dark', chipClass: 'bg-pastel-lime text-chip-ink', dotClass: 'bg-pastel-lime-dark', strokeClass: 'stroke-pastel-lime-dark' },
  { value: 'olive', label: 'เขียวมะกอก', swatchClass: 'bg-pastel-olive-dark', chipClass: 'bg-pastel-olive text-chip-ink', dotClass: 'bg-pastel-olive-dark', strokeClass: 'stroke-pastel-olive-dark' },
  { value: 'teal', label: 'เขียวมรกต', swatchClass: 'bg-pastel-teal-dark', chipClass: 'bg-pastel-teal text-chip-ink', dotClass: 'bg-pastel-teal-dark', strokeClass: 'stroke-pastel-teal-dark' },
  { value: 'sky', label: 'ฟ้าอมเขียว', swatchClass: 'bg-pastel-sky-dark', chipClass: 'bg-pastel-sky text-chip-ink', dotClass: 'bg-pastel-sky-dark', strokeClass: 'stroke-pastel-sky-dark' },
  { value: 'indigo', label: 'น้ำเงินอมม่วง', swatchClass: 'bg-pastel-indigo-dark', chipClass: 'bg-pastel-indigo text-chip-ink', dotClass: 'bg-pastel-indigo-dark', strokeClass: 'stroke-pastel-indigo-dark' },
  { value: 'violet', label: 'ม่วง', swatchClass: 'bg-pastel-violet-dark', chipClass: 'bg-pastel-violet text-chip-ink', dotClass: 'bg-pastel-violet-dark', strokeClass: 'stroke-pastel-violet-dark' },
  { value: 'plum', label: 'มัลเบอร์รี่', swatchClass: 'bg-pastel-plum-dark', chipClass: 'bg-pastel-plum text-chip-ink', dotClass: 'bg-pastel-plum-dark', strokeClass: 'stroke-pastel-plum-dark' },
  { value: 'coral', label: 'ส้มอมชมพู', swatchClass: 'bg-pastel-coral-dark', chipClass: 'bg-pastel-coral text-chip-ink', dotClass: 'bg-pastel-coral-dark', strokeClass: 'stroke-pastel-coral-dark' },
  { value: 'rose', label: 'กุหลาบ', swatchClass: 'bg-pastel-rose-dark', chipClass: 'bg-pastel-rose text-chip-ink', dotClass: 'bg-pastel-rose-dark', strokeClass: 'stroke-pastel-rose-dark' },
  // ชั้นอ่อน
  { value: 'mustard', label: 'มัสตาร์ด', swatchClass: 'bg-pastel-mustard-dark', chipClass: 'bg-pastel-mustard text-chip-ink', dotClass: 'bg-pastel-mustard-dark', strokeClass: 'stroke-pastel-mustard-dark' },
  { value: 'azure', label: 'ฟ้าสด', swatchClass: 'bg-pastel-azure-dark', chipClass: 'bg-pastel-azure text-chip-ink', dotClass: 'bg-pastel-azure-dark', strokeClass: 'stroke-pastel-azure-dark' },
  { value: 'jade', label: 'หยก', swatchClass: 'bg-pastel-jade-dark', chipClass: 'bg-pastel-jade text-chip-ink', dotClass: 'bg-pastel-jade-dark', strokeClass: 'stroke-pastel-jade-dark' },
  { value: 'orchid', label: 'กล้วยไม้', swatchClass: 'bg-pastel-orchid-dark', chipClass: 'bg-pastel-orchid text-chip-ink', dotClass: 'bg-pastel-orchid-dark', strokeClass: 'stroke-pastel-orchid-dark' },
