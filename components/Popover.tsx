    ...
    <div ref={ref} className="relative">
      <button
        ...
        className={`flex items-center gap-1.5 rounded-full border px-3.5 py-2 font-display text-caption font-semibold transition-colors ${
          open ? 'border-eddy-400 bg-eddy-50 text-ink' : 'border-eddy-200 bg-white text-ink-soft hover:bg-eddy-50'
        }`}
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={`absolute right-0 z-30 mt-2 max-h-[72vh] max-w-[calc(100vw-2rem)] overflow-y-auto rounded-clay border border-eddy-100 bg-white p-4 shadow-glow ${width}`}
          >
