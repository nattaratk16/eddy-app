...
export default function MobileNav() {
  ...
  return (
    <nav className="fixed inset-x-3 bottom-3 z-30 flex justify-around rounded-clay border border-eddy-100 bg-white/90 px-2 py-2 shadow-clay backdrop-blur-md md:hidden">
      {navItems.map((item) => {
